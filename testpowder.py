...
Original file is located at
    https://colab.research.google.com/drive/1L64AJFzLSiJq8d_Pq90dv3lr6nzNcs5W
"""
...
tourDescription = """
### For indoor over-th-air (OTA) Lab Experiment
...
- Server-class compute node (d430)
- Server-class compute node (d740)
...
portal.context.defineStructParameter(
    ...
    defaultValue=[{"freq_min": 3560.00, "freq_max": 3580.00}],
    multiValue=True,
    min=0,
